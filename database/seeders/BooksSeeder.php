...
class BooksSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['judul' => '7 in 1 pemrograman tingkat lanjut', 'harga_diskon'=>"59.840", 'harga'=>'74.800', 'link'=>'https://www.gramedia.com/products/7-in-1-pemrograman-web-tingkat-lanjut?queryID=475fcb19342d2db1882a3cee6334fe0f', 'image'=>'img/7 in 1 Pemrograman Web Tingkat Lanjut.png'],
        ];
